...
class Circle(CRideModel):
    ...
    name = models.CharField('circle name', max_length=120)
    ...
    is_limited = models.BooleanField(
        'limited',
        default=False,
        help_text='Limited circles can grow up to a fxed number of members.'
    )
    members_limit = models.PositiveSmallIntegerField(
        default=0,
